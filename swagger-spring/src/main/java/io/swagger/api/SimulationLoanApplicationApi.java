...
@Validated
@Api(value = "simulationLoanApplication", tags = {"auto-api-controller"})
//@RequestMapping(value = "/AutoSCFE")
public interface SimulationLoanApplicationApi {

    @ApiOperation(value = "Calculate one quote", nickname = "getSimulation", notes = "Get example loan cuotes for dealer", response = CalculateResponse.class, authorizations = {
        @Authorization(value = "JWTProfile", scopes = {
            @AuthorizationScope(scope = "sce", description = "sce")
            })
    })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "200 OK", response = CalculateResponse.class),
