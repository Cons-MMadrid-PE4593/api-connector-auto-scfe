...
public class ResponseError {
	...
	public ResponseError timestamp(String timestamp) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.debugMessage, responseError.debugMessage)
				&& Objects.equals(this.message, responseError.message)
				&& Objects.equals(this.status, responseError.status)
				&& Objects.equals(this.subErrors, responseError.subErrors)
